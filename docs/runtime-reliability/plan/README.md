...
| 2 | In progress | [02-simplify-control-plane.md](02-simplify-control-plane.md) | Delete duplicate exec and global admission polling; introduce single authoritative controller/registry flow. |
